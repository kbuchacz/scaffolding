...
public class ATMTest {
    ...
    public static WebArchive createDeployment() {
        WebArchive war = ShrinkWrap.create(WebArchive.class)
                .addClass(ATMCentral.class).addClass(ATM.class).addAsManifestResource(EmptyAsset.INSTANCE, "beans.xml");
        MavenResolverSystem resolver = Maven.resolver();
        File[] libraries = resolver.loadPomFromFile("pom.xml").resolve("org.mockito:mockito-core",
                "org.hamcrest:hamcrest-core:1.3", "org.apache.ant:ant:1.9.6").withTransitivity().as(File.class);
